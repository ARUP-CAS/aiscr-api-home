...
This guide is valid for **version 2.1** of the service and the schema.
...
- Endpoint: `https://api.aiscr.cz/2.1/oai`  
      *Note:* Generic `https://api.aiscr.cz/oai` endpoint resolves to the most recent version of data and schema.
- Schema: [https://api.aiscr.cz/schema/amcr/2.1/](https://api.aiscr.cz/schema/amcr/2.1/)
...
Description of sets' contents is available at: [https://api.aiscr.cz/oai?verb=ListSets](https://api.aiscr.cz/oai?verb=ListSets){.external}.
...
*Request:* [https://api.aiscr.cz/oai?verb=GetRecord&identifier=https://api.aiscr.cz/id/M-FT-110598700&metadataPrefix=oai_amcr](https://api.aiscr.cz/oai?verb=GetRecord&identifier=https://api.aiscr.cz/id/M-FT-110598700&metadataPrefix=oai_amcr){.external}

```zsh
curl 'https://api.aiscr.cz/oai?verb=GetRecord&identifier=https://api.aiscr.cz/id/M-FT-110598700&metadataPrefix=oai_amcr'
```
...
*Follow up request with `resumptionToken`:* [https://api.aiscr.cz/oai?verb=ListRecords&resumptionToken=BF0A0598B38E42E3FEB4E639B2911C90](https://api.aiscr.cz/oai?verb=ListRecords&resumptionToken=BF0A0598B38E42E3FEB4E639B2911C90){.external}

```zsh
curl 'https://api.aiscr.cz/oai?verb=ListRecords&resumptionToken=BF0A0598B38E42E3FEB4E639B2911C90'
```
