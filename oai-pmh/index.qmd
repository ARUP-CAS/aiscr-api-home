...
Endpoint for this version is: `https://api.aiscr.cz/2.1/oai`  
...
Generic `https://api.aiscr.cz/oai` endpoint resolves to the most recent version of the data, i.e. returns data in the schema used in the time of the last update of the specific record.  
Data in the previous version of the schema (v2.0) are available on the endpoint: `https://api.aiscr.cz/2.0/oai`
