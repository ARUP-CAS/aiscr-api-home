...
```sh 
curl -u <username>:<password> "https://digiarchiv.aiscr.cz/id/M-202301215-N00001/file/aa0cdd95-4bc4-4358-a831-2cf8672a3e4b/thumb" \
    -o thumbnail.jpg
```
...
| `page` | *integer* | Specific page number | `true` for multipage thumbnails endpoint | `1`, `2` |
